...
Crée un nouveau fichier dans les template (src/template) nav.html.twig\
coller ce code : 
...
puis aller dans votre fichier base.html.twig\
Et dans le body ajouter : \
